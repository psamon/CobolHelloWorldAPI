 ...
 * 
 */
public class CobolHelloWorldAPIFlowTest extends FlowTest {
	...
	private static final String TEST_FILE_001 = "CobolHelloWorldAPI.Test001.xml";
	private static final String applicationName = "CobolHelloWorldAPI-app";
	...
	public void injectData() throws IOException, ConfigManagerProxyPropertyNotInitializedException, ConfigManagerProxyLoggedException {
		...
		String message = IOUtils.toString(CobolHelloWorldAPIFlowTest.class.getResourceAsStream(TEST_FILE_001));
		String jsonBlob = TransformUtils.getBlob(message);
		String messageFormat = IOUtils.toString(CobolHelloWorldAPIFlowTest.class.getResourceAsStream(MESSAGE_FORMAT));
	...
	public void testOutput() throws ConfigManagerProxyPropertyNotInitializedException, XPathExpressionException, SAXException, IOException, ParserConfigurationException {	
		...
		logger.info("datalist[0] = {}", dataList.get(0));

		Node first = getNodeOutput(dataList.get(0), "/message/DFDL/SampleCopybook/Statement/FirstWord");
		Node second = getNodeOutput(dataList.get(0), "/message/DFDL/SampleCopybook/Statement/SecondWord");
		assertNotNull(first);
